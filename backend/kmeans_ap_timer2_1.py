...
def run_logic(input_industry, input_radioOption, input_algorithms,input_name,input_neighbor):
    ...
    # --- FIX STARTS HERE ---
    # Initialize these variables to None so they exist 
    # even if the specific algorithm loop doesn't run.
    df_lsh_brp = None
    ...
    return df_hyperparameters_clustering,potential_matches_df,execution_time,df_lsh_brp,df_lsh_minihash
...
# --- ΠΡΟΣΘΗΚΗ: Ορισμός του input_neighbor ---
    input_neighbor = 5  

    print(f"Running for: Industry={input_industry}, Name={input_name}, Algos={input_algorithms}")

    # --- ΔΙΟΡΘΩΣΗ: Πέρνα και το input_neighbor στην κλήση ---
